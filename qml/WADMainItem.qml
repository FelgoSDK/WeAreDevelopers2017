    ...
    headerView: Item {
      ...
      AppImage {
        ...
        layer.effect: Colorize {
          ...
          Connections {
              target: Theme
              onTintColorChanged: titleImgColorize.updateHue()
          }
          function updateHue() {
              titleImgColorize.baseColor = Theme.tintColor
              titleImgColorize.hue = loaderItem.colorToHsl(titleImgColorize.baseColor)[0]
          }
        }
      }
